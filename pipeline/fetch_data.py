#!/usr/bin/env python3
# ============================================================
#  >>> DESTINATION: TRAPP2 repo  →  pipeline/fetch_data.py  <<<
#  GoodGlobeLLC/TRAPP2/pipeline/fetch_data.py
#
#  Replace the existing pipeline/fetch_data.py in the TRAPP2 repo with
