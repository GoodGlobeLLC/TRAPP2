...
Produces 6 standardized scores in [-1, +1], each with a confidence in [0, 1]:
...
REFERENCE_TICKERS = ["SPY", "^VIX", "^VIX9D", "HYG", "LQD"] + SECTOR_ETFS
...
def compute_all():
    """Run all 6 signals. Returns dict ready for classify_regime."""
